  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto w-full pb-20 px-4 lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
         <div className="lg:col-span-4 bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm"><h4 className="font-black text-slate-900 text-lg mb-8 uppercase text-center">채널별 교환 점유율</h4><div className="h-[280px]"><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={channelStats.slice(0, 3)} innerRadius={65} outerRadius={90} paddingAngle={8} dataKey="count">{channelStats.map((e, i) => <Cell key={i} fill={['#f97316', '#fb923c', '#fdba74', '#fed7aa', '#ffedd5'][i % 5]} />)}</Pie><Tooltip /></PieChart></ResponsiveContainer></div></div>
